...
const en = {
  ...
  "adult.roster.title": "Members",
  "adult.roster.sub": "{count} profiles",
  "profile.title.sfw": "My Profile",
  "profile.title.nsfw": "My 18+ Profile",
  "profile.avatar": "Avatar",
  "profile.avatarUrl": "Image URL (https://…)",
  "profile.avatarApply": "Apply",
  "profile.avatarReset": "Reset to generated avatar",
  "profile.fields": "Profile fields — add, edit or remove any",
  "profile.addField": "Add field",
  "profile.noFields": "No custom fields yet. Add your first one.",
  "profile.fieldKey": "Label",
  "profile.fieldValue": "Value",
  "profile.delete": "Remove field",
  ...
  "profile.unknown": "You",
  "bond.stage.first": "First meeting",
  "bond.stage.familiar": "Getting close",
  "bond.stage.smitten": "Smitten",
  "bond.stage.devoted": "Devoted",
  "bond.stage.beloved": "Beloved",
  "bond.upgraded": "♥ Your bond with {name} deepened —",
  "bond.toNext": "{n} to next",
  "bond.greeting.morning": "Good morning",
  "bond.greeting.night": "Good night",
  "bond.greetingHint": "Daily greetings earn extra affection",
  "bond.greetingBonus": "Daily greeting: +3 ♥",
  "rp.tags.title": "Vibe tags",
  "rp.tags.hint": "Pick up to 5 archetypes — helps others find the chemistry they want.",
  "rp.tags.gentle": "Gentle guardian",
  "rp.tags.dominant": "Commanding love",
  "rp.tags.younger": "Younger sweetheart",
  "rp.tags.older": "Reserved senior",
  "rp.tags.childhood": "Childhood friend",
  "rp.tags.bickering": "Love-hate banter",
  "rp.tags.yandere": "Possessive darling",
  "rp.tags.cold": "Cold & aloof",
  "rp.tags.wild": "Wild & untamed",
  "rp.tags.gentleman": "The gentleman",
  "admin.errors.section": "Error log",
  "admin.errors.title": "Recent frontend errors",
  "admin.errors.empty": "No errors recorded — the app is healthy.",
  "admin.errors.refresh": "Refresh",
  "admin.errors.clear": "Clear log",
  "admin.errors.clearConfirm": "Clear all error records for this space?",
  "aigen.title": "AI Generate",
  "aigen.cardHint": "Describe the character you want — personality, setting, vibe — and AI will fill the whole card.",
  "aigen.cardPh": "e.g. A mysterious night-club owner who is secretly soft, sharp-tongued but protective…",
  "aigen.adultNote": "This card is adult-marked — the generator will allow mature themes.",
  "aigen.bookHint": "Describe the world you want — AI generates the world book plus 5–8 lore entries.",
  "aigen.bookPh": "e.g. A floating sky city where magic is banned but smuggled…",
  "aigen.generate": "Generate",
  "aigen.generating": "Generating…",
  "aigen.cancel": "Cancel",
  "aigen.createBook": "Create this world",
  "aigen.creating": "Creating…",
  "aigen.error": "Generation failed. Please try again.",
  ...
  "gateway.refresh.noFallback": "No model list available — type the model ID directly in the field above (most private endpoints don't expose /models).",
...
const zh: Record<keyof typeof en, string> = {
  ...
  "adult.roster.title": "成员档案",
  "adult.roster.sub": "{count} 份档案",
  "profile.title.sfw": "我的资料",
  "profile.title.nsfw": "我的 18+ 档案",
  "profile.avatar": "头像",
  "profile.avatarUrl": "图片链接 (https://…)",
  "profile.avatarApply": "应用",
  "profile.avatarReset": "重置为系统生成头像",
  "profile.fields": "资料字段——可自由添加、编辑或删除",
  "profile.addField": "添加字段",
  "profile.noFields": "还没有自定义字段，添加第一个吧。",
  "profile.fieldKey": "标签",
  "profile.fieldValue": "内容",
  "profile.delete": "删除字段",
  "profile.save": "保存资料",
  "profile.saving": "保存中…",
  "profile.saved": "已保存",
  ...
  "profile.roleMember": "成员",
  "profile.unknown": "你",
  "bond.stage.first": "初遇",
  "bond.stage.familiar": "相识",
  "bond.stage.smitten": "倾心",
  "bond.stage.devoted": "眷恋",
  "bond.stage.beloved": "热恋",
  "bond.upgraded": "♥ 你和 {name} 的关系升温了——",
  "bond.toNext": "还差 {n} 点",
  "bond.greeting.morning": "早安",
  "bond.greeting.night": "晚安",
  "bond.greetingHint": "每日问候可获得额外好感",
  "bond.greetingBonus": "每日问候 +3 ♥",
  "rp.tags.title": "心动标签",
  "rp.tags.hint": "最多选 5 个类型，帮 TA 找到想要的火花。",
  "rp.tags.gentle": "温柔守护",
  "rp.tags.dominant": "霸道宠爱",
  "rp.tags.younger": "年下奶狗",
  "rp.tags.older": "年上禁欲",
  "rp.tags.childhood": "青梅竹马",
  "rp.tags.bickering": "欢喜冤家",
  "rp.tags.yandere": "病娇偏执",
  "rp.tags.cold": "清冷疏离",
  "rp.tags.wild": "野性难驯",
  "rp.tags.gentleman": "绅士大叔",
  "admin.errors.section": "错误日志",
  "admin.errors.title": "最近的前端错误",
  "admin.errors.empty": "暂无错误记录——应用运行健康。",
  "admin.errors.refresh": "刷新",
  "admin.errors.clear": "清空日志",
  "admin.errors.clearConfirm": "确定清空本空间的所有错误记录？",
  "aigen.title": "AI 生成",
  "aigen.cardHint": "描述你想要的角色——性格、背景、感觉——AI 会直接填满整张卡。",
  "aigen.cardPh": "例如：一位神秘的夜店老板，表面毒舌实则温柔，26 岁，护短……",
  "aigen.adultNote": "这张卡已标记为成人向——生成器将允许成熟内容。",
  "aigen.bookHint": "描述你想构建的世界——AI 会生成世界书及 5–8 条设定条目。",
  "aigen.bookPh": "例如：漂浮在云端的天空之城，魔法被禁止却在暗中流通……",
  "aigen.generate": "生成",
  "aigen.generating": "生成中…",
  "aigen.cancel": "取消",
  "aigen.createBook": "创建这个世界",
  "aigen.creating": "创建中…",
  "aigen.error": "生成失败，请重试。",
  ...
  "gateway.refresh.noFallback": "未能取到模型列表——请在上方字段直接输入模型 ID（多数私有端点不开放 /models）。",
